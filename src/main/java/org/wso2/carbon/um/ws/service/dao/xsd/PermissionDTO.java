...
public class PermissionDTO {
    ...
    @XmlElementRef(name = "action", namespace = "http://dao.service.ws.um.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> action;
    @XmlElementRef(name = "resourceId", namespace = "http://dao.service.ws.um.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
