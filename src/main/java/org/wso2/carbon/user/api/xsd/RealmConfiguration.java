 ...
 *         &lt;element name="isOverrideUsernameClaimFromInternalUsername" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "RealmConfiguration", propOrder = {
    "addAdmin",
    "adminPassword",
    "adminRoleName",
    "adminUserName",
...
public class RealmConfiguration {
    ...
    @XmlElementRef(name = "addAdmin", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "adminRoleName", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> adminRoleName;
    @XmlElementRef(name = "adminUserName", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> adminUserName;
    @XmlElementRef(name = "authorizationManagerClass", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> authorizationManagerClass;
    @XmlElement(nillable = true)
    protected List<String> authzProperties;
    @XmlElementRef(name = "description", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> description;
    @XmlElementRef(name = "everyOneRoleName", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> everyOneRoleName;
    @XmlElementRef(name = "isOverrideUsernameClaimFromInternalUsername", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> isOverrideUsernameClaimFromInternalUsername;
    @XmlElement(nillable = true)
    protected List<String> multipleCredentialProps;
    protected Boolean passwordsExternallyManaged;
    @XmlElementRef(name = "persistedTimestamp", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> persistedTimestamp;
    protected Boolean primary;
    @XmlElementRef(name = "realmClassName", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> realmClassName;
    @XmlElement(nillable = true)
    protected List<String> realmProperties;
    @XmlElementRef(name = "secondaryRealmConfig", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<RealmConfiguration> secondaryRealmConfig;
    protected Integer tenantId;
    @XmlElementRef(name = "userStoreClass", namespace = "http://api.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    ...
    public void setAuthorizationManagerClass(JAXBElement<String> value) {
        this.authorizationManagerClass = value;
    }
    ...
    public void setEveryOneRoleName(JAXBElement<String> value) {
        this.everyOneRoleName = value;
    }

    /**
     * Gets the value of the isOverrideUsernameClaimFromInternalUsername property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getIsOverrideUsernameClaimFromInternalUsername() {
        return isOverrideUsernameClaimFromInternalUsername;
    }

    /**
     * Sets the value of the isOverrideUsernameClaimFromInternalUsername property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setIsOverrideUsernameClaimFromInternalUsername(JAXBElement<String> value) {
        this.isOverrideUsernameClaimFromInternalUsername = value;
    }
    ...
    public void setSecondaryRealmConfig(JAXBElement<RealmConfiguration> value) {
        this.secondaryRealmConfig = value;
    }
