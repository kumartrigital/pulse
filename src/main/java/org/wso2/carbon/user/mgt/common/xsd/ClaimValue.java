...
@XmlType(name = "ClaimValue", propOrder = {
    "claimURI",
    "value"
})
public class ClaimValue {

    @XmlElementRef(name = "claimURI", namespace = "http://common.mgt.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> claimURI;
    @XmlElementRef(name = "value", namespace = "http://common.mgt.user.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
